...
| [Identity Assertion Authorization Grant — ID-JAG / Cross-App Access](https://datatracker.ietf.org/doc/draft-ietf-oauth-identity-assertion-authz-grant/) |         | 🧪 🧩 [`oidc-id-jag`](plugins/oidc-id-jag)                                                                                           |
